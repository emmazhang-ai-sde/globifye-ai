...
| [Step 7 — Agent roadmap](./sip-loop-mvp-step-by-step-guidence/step7-agent-roadmap.md) | RAG evolution (see `rag-per-company-kb-design-doc.md`), AI/salesperson switching, deferred-scope list | **Designs only — nothing implemented.** Awaiting PM review. |
